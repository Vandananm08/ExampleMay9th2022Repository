...
public class XPathDemo {
	...
	{
		oBrowser.findElement(By.xpath("//input[2]")).sendKeys("Welcome@123");
	}
	/**
	 * Case 3: Identify the Element based on TagName with attributename and value combination
	 * Syntax: //<tagName>[@attributename='attributevalue']
	 */
	private static void relativeXPathUsingTagNameWithAttributeNameValue()
	{
		oBrowser.findElement(By.xpath("//input[@name='pass1word1']")).sendKeys("Welcome@123");
	}
	/**
	 * Case 4: Identify the Element based on attributename and value combination
	...
	/**
	 * Case 5: Identify the Element based on attributename value alone
	...
	/**
	 * Case 6: Identify the Element based on TagName with Multiple attributename and value combination
	...
	private static void relativeXPathUsingTagNameWithMultipleAttributeNameValue()
	{
		...
		oBrowser.findElement(By.xpath("//input[@type='button'][@class='submit1btn1']")).click();
	}
	/**
	 * Case 7: Identify the Element based on TagName with Multiple attributename and value 
	 * combination using AND operator
	...
	/**
	 * Case 8: Identify the Element based on TagName with Multiple attributename and value 
	 * combination using or operator
	...
	/**
	 * Case 9: Identify the Element based on TagName with attributename and partial attribute value 
	 * combination
	 * Syntax: 
