...
public class XPathAxesDemo {
	...
	public static void main(String[] args) {
		...
		FromTableReferenceits3rdRecordEnterSalary();
	}
	...
	//	oBrowser.findElement(By.xpath("//td[text()='Indian Freedom Fighter']/preceding-siblig::td[2]/input")).click();
	}
	/**
	 *  preceding
	...
	private static void FromTableReferenceits3rdRecordEnterSalary()
	{
		WebElement Oele=oBrowser.findElement(By.xpath("//table[@id='tbl1']/descendant::tr[3]/td[6]/input"));
		Oele.sendKeys("20000");
	}
