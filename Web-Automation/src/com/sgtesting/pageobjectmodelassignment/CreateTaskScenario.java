...
public class CreateTaskScenario {
	...
	private static void createTask()
	{
		try
		{
			oPage.getoAddNewTask().click();
			Thread.sleep(2000);
			oPage.getoCreateNewTask().click();
			Thread.sleep(2000);
			oPage.getoEnterFirstTask().sendKeys("Testcase1");
			Thread.sleep(2000);
			oPage.getCreateTasksPopup_commitBtn().click();
			Thread.sleep(2000);
			}catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void deleteTask()
	{
		try
		{
			oPage.getoSelectCreateTask().click();
			Thread.sleep(2000);
			oPage.getoClickDeleteTask().click();
			Thread.sleep(2000);
			oPage.getdeleteTaskPopup_deleteConfirm_submitBtn().click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
